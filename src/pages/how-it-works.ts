  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <span class="text-[11px] text-epig-textDim">SPY → A, FUT/FOP/OPT → B, other STK → C &mdash; duplicates rejected</span>
            </div>
          </div>
          <div class="flex items-center gap-3">
    ...
    <div class="kpi-card mb-8">
      <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="font-bold text-xl">Three Strategies. One System.</h2>
      </div>
      <p class="text-sm text-epig-textMuted leading-relaxed mb-6">
        EPIG runs three integrated strategies &mdash; each designed for a different return profile.
        Together, they create a portfolio that protects capital, generates income, and captures asymmetric upside.
      </p>

      <div class="space-y-4">
        <!-- Strategy A: SPY Core -->
        <div class="rounded-xl border border-blue-500/20 bg-blue-500/[0.03] p-5">
          <div class="flex items-center gap-3 mb-3">
            <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-xs font-bold uppercase bg-blue-500/15 text-blue-400 border border-blue-500/30">A</span>
            <div>
              <h3 class="font-bold text-white text-sm">SPY Core</h3>
              <span class="text-[11px] text-blue-400/70 font-mono">SPY only (STK) &bull; 70% allocation</span>
            </div>
          </div>
          <p class="text-xs text-epig-textDim leading-relaxed">
            Core market exposure through SPY (S&amp;P 500 ETF). Targets <strong class="text-white">2x market returns</strong>
            through amplified upside capture (~110%) and structural downside protection (capturing only &frac13; of losses).
          </p>
        </div>
        ...
        <div class="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.03] p-5">
          <div class="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <span class="text-[11px] text-emerald-400/70 font-mono">FUT / FOP / OPT &bull; 20% allocation</span>
            </div>
        ...
        <div class="rounded-xl border p-5" style="border-color: rgba(245,158,11,0.3); background: rgba(245,158,11,0.03);">
          <div class="flex items-center gap-3 mb-3">
            <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-xs font-bold uppercase border" style="background: rgba(245,158,11,0.15); color: #f59e0b; border-color: rgba(245,158,11,0.3);">C</span>
            <div>
              <h3 class="font-bold text-white text-sm">Episodic Pivot</h3>
              <span class="text-[11px] font-mono" style="color: rgba(245,158,11,0.7);">Individual stocks (non-SPY STK) &bull; 10% allocation</span>
            </div>
          </div>
          <p class="text-xs text-epig-textDim leading-relaxed">
            Opportunistic allocation to individual stocks at opportune times. Conviction setups with asymmetric reward profiles,
            deployed selectively around catalysts and dislocations. Adds asymmetric upside without compromising the core.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="kpi-card mb-8">
      ...
      <p class="text-sm text-epig-textMuted leading-relaxed mb-6">
        ...
        every time a trade is placed across any of the three strategies.
      </p>
